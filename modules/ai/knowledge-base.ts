...
const SKIN: ConditionEntry[] = [
  ...
  {
    id: 'boil-abscess', name: 'Boil / Abscess', category: 'skin',
    symptoms: ['boil', 'abscess', 'pus', 'lump', 'painful bump', 'swollen red', 'furuncle', 'carbuncle', 'bump with pus'],
    keySigns: ['Tender, red, swollen lump', 'Pus pointing at the center', 'Warm to touch'],
    severity: 'moderate',
    actionSteps: ['Apply warm compress 3-4 times a day', 'Do NOT squeeze or pop the boil', 'Keep area clean and covered'],
    otc: 'Paracetamol for pain if needed',
    referral: 'Refer to PHC if on face/spine, very large, not draining after days, or with fever',
    source: 'NHM Guidelines', followUp: '3 days',
  },
  {
    id: 'psoriasis', name: 'Psoriasis', category: 'skin',
    symptoms: ['psoriasis', 'thick scales', 'silvery scale', 'red thick patch', 'chronic scale', 'elbow scale', 'knee patch'],
    keySigns: ['Well-demarcated red plaques', 'Silvery-white scales', 'Common on extensor surfaces (knees, elbows)', 'Chronic'],
    severity: 'moderate',
    actionSteps: ['Apply emollients and moisturizers frequently', 'Avoid trauma to the skin', 'Counsel that it is not contagious'],
    otc: 'Moisturizing cream (petroleum jelly based)',
    referral: 'Refer to Medical Officer / Dermatologist for specific treatment',
    source: 'WHO Skin Guidelines', followUp: '4 weeks',
  },
  {
    id: 'vitiligo', name: 'Vitiligo', category: 'skin',
    symptoms: ['vitiligo', 'white patch', 'loss of color', 'pigment loss', 'leucoderma', 'white spot'],
    keySigns: ['Depigmented (chalk-white) patches', 'No scaling', 'Normal sensation (distinguishes from leprosy)'],
    severity: 'mild',
    actionSteps: ['Check sensation in the patch to rule out Leprosy', 'Reassure patient it is not contagious', 'Protect depigmented skin from direct sunlight'],
    otc: null,
    referral: 'Refer to Dermatologist for diagnosis and treatment options',
    source: 'NHM Guidelines', followUp: 'Routine',
  },
];
...
const CHILD: ConditionEntry[] = [
  ...
  {
    id: 'dengue', name: 'Dengue Fever', category: 'child_health',
    symptoms: ['dengue', 'high fever', 'joint pain', 'bone pain', 'eye pain', 'retro-orbital', 'rash fever', 'bleeding gum', 'nosebleed'],
    keySigns: ['High-grade fever', 'Severe body/joint pain (breakbone fever)', 'Pain behind eyes', 'Petechial rash', 'Bleeding signs (warning sign)'],
    severity: 'severe',
    actionSteps: ['Give Paracetamol for fever', 'Do NOT give Aspirin or Ibuprofen', 'Give plenty of oral fluids (ORS, coconut water)'],
    otc: 'Paracetamol + ORS',
    referral: 'Refer to PHC/Hospital immediately if severe abdominal pain, vomiting, or any bleeding',
    source: 'NHM Dengue Protocol', followUp: 'Daily',
  },
  {
    id: 'typhoid', name: 'Typhoid Fever', category: 'child_health',
    symptoms: ['typhoid', 'long fever', 'stomach pain fever', 'weakness', 'headache fever', 'step ladder fever', 'enteric'],
    keySigns: ['Prolonged fever > 5 days', 'Abdominal pain', 'Fatigue/weakness', 'Coated tongue'],
    severity: 'moderate',
    actionSteps: ['Give paracetamol for fever', 'Maintain hydration and nutrition', 'Promote handwashing and safe drinking water'],
    otc: 'Paracetamol',
    referral: 'Refer to PHC for Widal test / antibiotics if fever > 5 days',
    source: 'NHM Guidelines', followUp: '3 days',
  },
  {
    id: 'tb-suspect', name: 'Tuberculosis (TB) Suspect', category: 'child_health',
    symptoms: ['tb', 'tuberculosis', 'cough long', 'blood in cough', 'night sweat', 'weight loss', 'evening fever', 'chest pain cough'],
    keySigns: ['Cough > 2 weeks', 'Weight loss or no weight gain', 'Evening fever', 'Night sweats', 'Blood in sputum'],
    severity: 'severe',
    actionSteps: ['Counsel on cough etiquette (cover mouth)', 'Isolate if possible', 'Collect sputum sample if trained'],
    otc: null,
    referral: 'URGENT referral to designated microscopy center / PHC for TB testing',
    source: 'RNTCP / NTEP Guidelines', followUp: 'Follow up to ensure testing was done',
  },
  {
    id: 'conjunctivitis', name: 'Conjunctivitis (Pink Eye)', category: 'child_health',
    symptoms: ['red eye', 'pink eye', 'eye discharge', 'sticky eye', 'watery eye', 'eye pain', 'conjunctivitis', 'madras eye'],
    keySigns: ['Redness of the sclera', 'Watery or purulent discharge', 'Eyelids stuck together in morning', 'Itching or gritty feeling'],
    severity: 'mild',
    actionSteps: ['Clean eyes with clean water and cotton (inside to outside)', 'Wash hands frequently', 'Do NOT share towels or eye drops'],
    otc: null,
    referral: 'Refer if vision is affected, severe pain, or no improvement in 3 days',
    source: 'IMNCI Protocol', followUp: '3 days',
  },
  {
    id: 'asthma', name: 'Asthma / Wheezing', category: 'child_health',
    symptoms: ['asthma', 'wheeze', 'whistling breath', 'chest tight', 'breathing problem', 'breathless', 'inhaler'],
    keySigns: ['Wheezing (whistling sound when breathing out)', 'Difficulty breathing', 'Chest tightness', 'Cough worse at night'],
    severity: 'moderate',
    actionSteps: ['Help patient sit upright', 'Administer prescribed inhaler if available (Salbutamol)', 'Keep calm and reassure'],
    otc: null,
    referral: 'URGENT referral if breathing is very difficult, unable to speak in sentences, or lips turn blue',
    source: 'IMNCI Protocol', followUp: '24 hours',
  },
];
...
const NUTRITION: ConditionEntry[] = [
  ...
  {
    id: 'rickets', name: 'Vitamin D Deficiency (Rickets)', category: 'malnutrition',
    symptoms: ['rickets', 'bone bend', 'bow legs', 'knock knees', 'delayed walking', 'bone pain', 'soft bone', 'vitamin d'],
    keySigns: ['Bowed legs or knock knees', 'Widened wrists', 'Delayed standing or walking', 'Prominent forehead'],
    severity: 'moderate',
    actionSteps: ['Advise daily sun exposure (morning/evening)', 'Promote Vitamin D and Calcium-rich foods (milk, eggs)', 'Ensure routine supplements are given'],
    otc: null,
    referral: 'Refer to Medical Officer for Vitamin D/Calcium prescription and evaluation',
    source: 'NHM Guidelines', followUp: '1 month',
  },
  {
    id: 'goiter', name: 'Iodine Deficiency (Goiter)', category: 'malnutrition',
    symptoms: ['goiter', 'neck swell', 'goitre', 'thyroid', 'throat lump', 'iodine', 'neck lump'],
    keySigns: ['Visible swelling in the front of the neck', 'Sluggishness or delayed milestones (if congenital)'],
    severity: 'moderate',
    actionSteps: ['Check if household uses iodized salt', 'Advise mandatory use of iodized salt (store in closed container)'],
    otc: null,
    referral: 'Refer to PHC for thyroid function testing and treatment',
    source: 'NIDDCP Guidelines', followUp: '1 month',
  },
];
