// Builds the constrained, defensive prompt for Gemma 4.
...
You analyze a photo of skin and the worker's symptom description.
...
Analyze the attached skin photo and the symptom description above.
